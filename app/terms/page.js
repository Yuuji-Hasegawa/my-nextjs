		...
		<>
			<div className='o-center :rd-bx u-px-clamp u-pb-xl'>
				...
				<p className='c-content-l u-fnt-wx'>
					本サイト規約（以下「本規約」と言います。）には、本サイトの利用条件及び当社とユーザーの皆様との間の権利義務関係が定められています。
					<br />
				...
				<dl className='o-stack u-mb-xl'>
					...
					<dd className='c-content-l u-fnt-wx'>
						...
						<ol className='c-cnt-list :secondary'>
							...
							<li>「当社」とは、{config.terms.company}を意味します。</li>
							<li>
								「当社ウェブサイト」とは、そのドメインが「{config.terms.domain}
							...
							<li>
								「本サイト」とは、当社が提供する{config.terms.name}
								という名称のウェブサイト（理由の如何を問わずウェブサイトの名称または内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
							</li>
						</ol>
					</dd>
					...
					<dd className='c-content-l u-fnt-wx'>
						...
						<ol className='c-cnt-list :secondary'>
							...
							<li>
								当社ウェブサイト上で掲載する本サイト利用に関するルール(
								<Link
									className='c-lnk-txt :has-line :has-color'
									href={`${protocol + config.site.host + '/terms'}`}
									target='_blank'
									rel='noopener noreferrer'
								>
									<span className='u-fnt-wl :slnt'>{`${protocol + config.site.host + '/terms'}`}</span>
								</Link>
								)に抵触する行為
							</li>
							<li>反社会的勢力等への利益供与</li>
					...
					<dd className='c-content-l u-fnt-wx'>
						<ol className='c-cnt-list'>
							...
							<li>
								当社は、本サイトに関してユーザーが被った損害につき、過去{config.terms.payterm}
								にユーザーが当社に支払った対価の金額を超えて賠償する責任を負わないものとし、また、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。
							</li>
							<li>
						...
						<ol className='c-cnt-list'>
							<li>
								...
								<Link
									...
									rel='noopener noreferrer'
								>
									<span className='u-fnt-wl :slnt'>{`${protocol + config.site.host + '/privacy-policy'}`}</span>
								</Link>
					...
					<dd className='c-content-l u-fnt-wx'>
						<ol className='c-cnt-list'>
							...
							<li>
								本規約またはサイト利用契約に起因し、または関連する一切の紛争については、{config.terms.court}
								を第一審の専属的合意管轄裁判所とします。
							</li>
						</ol>
					</dd>
