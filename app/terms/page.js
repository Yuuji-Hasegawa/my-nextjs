...
export default function Terms() {
	...
	const termsUri = protocol + config.site.host + '/terms';
	const ppUri = protocol + config.site.host + '/privacy-policy';

	return (
		<>
			<div className="o-center :rd-bx u-px-clamp u-pb-xl">
				<h1 className="c-heading u-fnt-wt">サイト規約</h1>
				...
				<dl className='o-stack u-mb-xl'>
					<dt className='c-sec-heading u-fnt-wt u-txt-ctr'>第1条（適用）</dt>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第2条（定義）</dt>
					<dd className="c-content-l u-fnt-wx">
						...
						<ol className="c-cnt-list :secondary">
							...
							<li>
								「当社」とは、{config.terms.company}を意味します。
							</li>
							<li>
								「当社ウェブサイト」とは、そのドメインが「{config.terms.domain}」である、当社が運営するウェブサイト（理由の如何を問わず、当社のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
							</li>
							<li>「ユーザー」とは、本サイトの利用者として情報の閲覧を行う個人または法人を意味します。</li>
							<li>
								「本サイト」とは、当社が提供する{config.terms.name}という名称のウェブサイト（理由の如何を問わずウェブサイトの名称または内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
							</li>
						</ol>
					</dd>
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第3条（サイトの利用）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第4条（禁止事項）</dt>
					<dd className="c-content-l u-fnt-wx">
						...
						<ol className="c-cnt-list :secondary">
							...
							<li>
								当社ウェブサイト上で掲載する本サイト利用に関するルール(<Link className="c-lnk-txt :has-line :has-color"
									href={termsUri}
									target="_blank" rel="noopener noreferrer"><span
										className="u-fnt-wl :slnt">{termsUri}</span></Link>)に抵触する行為
							</li>
							<li>反社会的勢力等への利益供与</li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第5条（本サイトの停止等）</dt>
					<dd className="c-content-l u-fnt-wx">
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第6条（権利帰属）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第7条（本サイトの内容の変更、終了）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第8条（保証の否認及び免責）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>
							...
							<li>
								当社は、本サイトに関してユーザーが被った損害につき、過去{config.terms.payterm}にユーザーが当社に支払った対価の金額を超えて賠償する責任を負わないものとし、また、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。
							</li>
							<li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第9条（利用者情報の取扱い）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>
								当社によるユーザーの利用者情報の取扱いについては、別途当社プライバシーポリシー(<Link className="c-lnk-txt :has-line :has-color"
									href={ppUri}
									target="_blank" rel="noopener noreferrer"><span
										className="u-fnt-wl :slnt">{ppUri}</span></Link>)の定めによるものとし、ユーザーはこのプライバシーポリシーに従って当社がユーザーの利用者情報を取扱うことについて同意するものとします。
							</li>
							<li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第10条（本規約等の変更）</dt>
					<dd className="c-content-l u-fnt-wx">
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第11条（連絡/通知）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第12条（分離可能性）</dt>
					<dd className="c-content-l u-fnt-wx">
						本規約のいずれかの条項またはその一部が、消費者契約法その他の法令等により無効または執行不能と判断された場合であっても、本規約の残りの規定及び一部が無効または執行不能と判断された規定の残りの部分は、継続して完全に効力を有するものとします。
					</dd>
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第13条（準拠法及び管轄裁判所）</dt>
					<dd className="c-content-l u-fnt-wx">
						<ol className="c-cnt-list">
							<li>本規約及びサイト利用契約の準拠法は日本法とします。</li>
							<li>
								本規約またはサイト利用契約に起因し、または関連する一切の紛争については、{config.terms.court}を第一審の専属的合意管轄裁判所とします。
							</li>
						</ol>
					</dd>
				</dl>
				<p className='c-suppl-l u-txt-r u-fnt-wx'>
					2024年05月01日 制定
				</p>
			</div>
			<BreadCrumb />
