...
export default function NotFound() {
	...
	if (decodeURI(useSearchParams()).toString() !== '') {
    uri += `?${decodeURI(useSearchParams()).toString()}`;
  }
	...
	return (
		<>
			<div className="o-center :rd-bx u-px-clamp u-pb-xl">
				...
				<p className="c-content-l u-fnt-wx u-mb-l">大変申し訳ございませんが、お探しのページ(URL:{uri})は見つかりませんでした。<br />
					アドレスバーに直接URLを入力された場合は、アドレスが正しく入力されているか、もう一度ご確認下さい。 </p>
				<p className="c-content-l u-fnt-wx u-mb-l">正しいアドレスを入力しても表示されない場合は、一時的にアクセスできない状況にあるか、移動もしくは削除された可能性があります。<br />
					その場合お手数ですがトップページからお求めのページを再度お探しください。 </p>
