...
export default function PrivacyPolicy() {
	const mailto = 'mailto:' + config.mail.primary;
		...
		<>
			<div className="o-center :rd-bx u-px-clamp u-pb-xl">
				...
				<p className="c-content-l u-fnt-wx">
					{config.terms.company}（以下「当社」といいます。）は、当社の提供するサービス（以下「本サービス」といいます。）における、ユーザーについての個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
				</p>
				<dl className="o-stack u-mb-xl">
					...
					<dd className="c-content-l u-fnt-wx">
						...
						<ol className="c-cnt-list :secondary">
							<li>
								<span className="u-text-weight-b">ユーザーからご提供いただく情報</span><br />
							...
							<li>
								<span className="u-text-weight-b">ユーザーが本サービスの利用において、他のサービスと連携を許可することにより、当該他のサービスからご提供いただく情報</span><br />
							...
							<li>
								<span className="u-text-weight-b">ユーザーが本サービスを利用するにあたって、当社が収集する情報</span><br />
							...
							<li>
								<span className="u-text-weight-b">ユーザーが本サービスを利用するにあたって、当社がユーザーの個別同意に基づいて収集する情報</span><br />
					...
					<dt className="c-sec-heading u-fnt-wt u-txt-ctr">第3条（通知・公表または同意取得の方法、利用中止要請の方法）</dt>
					<dd className="c-content-l u-fnt-wx">
								...
								<dl className="o-sidebar u-space-none u-insert-sidebar u-mt-s">
									...
									<dd className="o-box :td-bx u-py-s u-px-m">
										<a className="c-lnk-txt :has-line :has-color u-dsp-b"
											href="https://policies.google.com/privacy?hl=ja" target="_blank" rel="noopener noreferrer">
											<span className="u-fnt-wl :slnt">
									...
									<dd className="o-box :td-bx u-py-s u-px-m">
										<a className="c-lnk-txt :has-line :has-color u-dsp-b"
											href="https://support.google.com/analytics/answer/181881?hl=ja" target="_blank" rel="noopener noreferrer">
											<span className="u-fnt-wl :slnt">
							...
							<dd className="o-box :td-bx u-py-s u-px-m">
								<a className="c-lnk-txt :has-line :has-color u-dsp-b"
									...
									target="_blank" rel="noopener noreferrer"><span
										className="u-fnt-wl :slnt">{config.mail.primary}</span></a>
							</dd>
						</dl>
					</dd>
